...
## Front end
LogIt provides a logging front-end; this is the API your code (using LogIt) will call to log messages. The front-end is fixed, and is provided via the interface file LogIt.h.
## Back ends
